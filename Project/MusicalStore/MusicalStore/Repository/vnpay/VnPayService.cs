...
namespace MusicalStore.Repository.vnpay
{
    public class VnPayService : IVnPayService
    {
        ...
        public string CreatePaymentUrl(OrderModel model, HttpContext context)
        {
            ...
            pay.AddRequestData("vnp_OrderInfo", $"{model.UserName} {model.OrderInfo} {model.TotalAmount}");
            //pay.AddRequestData("vnp_OrderInfo", $"Test Thanh Toan");
