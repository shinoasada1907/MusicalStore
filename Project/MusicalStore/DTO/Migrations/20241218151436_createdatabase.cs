        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenKH = table.Column<string>(type: "nvarchar(250)", unicode: false, maxLength: 50, nullable: true),
                    Email = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    SDT = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 11, nullable: true),
                    ...
                    AnhDaiDien = table.Column<string>(type: "nvarchar(250)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaCtGiamGia = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MaCtGiamGiaNavigationMaSp = table.Column<string>(type: "varchar(10)", nullable: true),
                    MaCtGiamGiaNavigationMaGg = table.Column<string>(type: "varchar(10)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.MaCtGiamGiaNavigationMaSp, x.MaCtGiamGiaNavigationMaGg },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaDH = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CT_DON_H__52737C6725ADE823", x => x.MaCtDh);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK__SAN__PHAM__MaSP__5AEE82B9",
                        column: x => x.MaSP,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CT_DON_HANG_MaDH",
                table: "CT_DON_HANG",
                column: "MaDH");

            migrationBuilder.CreateIndex(
                name: "IX_CT_DON_HANG_MaSP",
                table: "CT_DON_HANG",
                column: "MaSP");
